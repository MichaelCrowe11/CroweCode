...
#
# This file includes or adapts code patterns compatible with the vLLM project
# (https://github.com/vllm-project/vllm) under the Apache License 2.0.
# Attribution is preserved per Apache-2.0 requirements. See NOTICE for details.
